...
object CityUtils {
    ...
    val map: Map<Int, CityInfo> = mapOf(
        ...
        112 to CityInfo("NL","Wageningen",LatLng(51.9755846,5.6679461),URL("https://www.cykl.nl/gbfs/gbfs.json")),
        ...
        123 to CityInfo("PL","Lublin",LatLng(51.2394572,22.5661087),URL("https://gbfs.nextbike.net/maps/gbfs/v1/nextbike_ln/gbfs.json")),
